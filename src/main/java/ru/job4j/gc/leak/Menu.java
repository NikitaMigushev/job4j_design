...
public class Menu {
    ...
    public static final Integer EXIT_APP = 5;
    ...
    public static final String ID_FOR_DELETE = "Удалить все посты";
    ...
    public static final String MENU = """
                ...
                Введите 5, чтобы выйти из пронраммы.
            """;
